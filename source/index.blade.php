...
<section class="flex-col justify-center items-center text-center mb-20">
    ...
    <h1 >Receive immediate notification of my trades. Sign up to my Live Trading Telegram channel by following the below 3 steps.</h1>
    ...
    <div class="flex items-center justify-center mx-auto pt-4">
        <div class="px-1 mx-4">
            <a href="https://twitter.com/Crypto_mars" target="_blank" rel="noopener">
        ...
        <div class="px-1 mx-4">
            <a href="https://www.youtube.com/channel/UCer_FjFiyM8L54d0YiAsF7Q?" target="_blank" rel="noopener">
        ...
        <div class="px-1 mx-4">
            <a href="https://www.github.com/GavinMarsh" target="_blank" rel="noopener">
